                ...
                {user ? (
                  ...
                  <div className="bg-gray-100 p-4 rounded-lg">
                    ...
                    <div className="flex justify-center space-x-4">
                      ...
                      <Link
                        to="/sign-up"
                        className="px-4 py-2 border border-indigo-600 text-indigo-600 font-medium rounded-lg hover:bg-indigo-50 transition-colors"
                      >
                        Sign Up
                      </Link>
                    </div>
      ...
      <section className="py-16 bg-gray-100">
        <div className="container mx-auto px-4 text-center">
          ...
          {!user && (
            <Link
              to="/sign-up"
              className="px-8 py-4 bg-indigo-600 text-white font-medium text-lg rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors"
            >
